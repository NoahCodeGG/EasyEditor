const propertyNameRequiresQuotes = (propertyName: string) => {
  try {
    const context = {
...
const quoteString = (str: string, { doubleQuote }: any) => {
...
export const getSource = (value: any): string => {
