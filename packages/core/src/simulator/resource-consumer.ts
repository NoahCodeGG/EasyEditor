...
import { type Simulator, type SimulatorRenderer, isSimulatorRenderer } from './'
...
export default class ResourceConsumer<T = any> {
  private emitter = createEventBus('ResourceConsumer')

  @observable.ref private accessor _data: T | typeof UNSET = UNSET
